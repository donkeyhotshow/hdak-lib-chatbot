...
**🆕 Основна功能:** Чат **автоматично ищет** в электронном каталоге ХДАК!  
👉 [Полная документация про поиск в каталоге](./DOCUMENTATION_INDEX.md)

## ⚡ Основные возможности

- ✅ **Автоматический поиск в каталоге** — система сама ищет книги при любом запросе
- ✅ **6 типов поиска** — по названию, автору, теме, УДК, ключевым словам
- ✅ **Умные рекомендации** — предлагает материалы по теме когда вы спрашиваете
- ✅ **Параллельное выполнение** — все поиски одновременно (~2 сек ответ)
- ✅ **История чатов** — полная история диалогов в базе
- ✅ **Мобильная оптимизация** — работает идеально на всех устройствах
- ✅ **Речь в текст** — Speech Recognition для голосового ввода
- ✅ **Доступность** — WCAG 2.1 AA compliance, полный ARIA поддержка
...
- Logger + Retry utilities (production-ready)
