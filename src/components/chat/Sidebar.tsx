    ...
    >
      ...
      <div className="flex items-center gap-0.5 shrink-0">
        {editing ? (
          <button
            onClick={submitEdit}
            className="p-1 text-[#D4A853]/60 hover:text-[#D4A853] transition-colors rounded"
            aria-label="Зберегти"
          >
          ...
          <button
            onClick={startEdit}
            className="p-1 text-white/0 group-hover:text-white/20 hover:!text-[#D4A853]/60 transition-all rounded"
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.aside
            ...
            className="sidebar-premium fixed md:relative z-50 flex flex-col"
          >
            {/* HEADER */}
